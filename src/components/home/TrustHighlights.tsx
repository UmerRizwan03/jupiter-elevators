      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="max-w-3xl mx-auto text-center space-y-3">
          <span className="text-xs font-bold text-brand-gold uppercase tracking-wider">
            {locale === "ar" ? "لماذا يختارنا مقاولو المصاعد؟" : "Why Lift Contractors Choose Us"}
          </span>
          <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">
            {locale === "ar"
              ? "شريكك الاستراتيجي لحلول وقطع غيار المصاعد في المملكة"
              : "Your Strategic Elevator Spare Parts Partner in Saudi Arabia"}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-3 hover:shadow-lg transition-shadow">
